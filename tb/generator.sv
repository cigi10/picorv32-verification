...
class generator;
  ...
  task generate_directed_tests();
    ...
    trans = new(); trans.opcode = 7'b0100011;  trans.funct3 = 3'b001; trans.rd = 0; trans.rs1 = 0; trans.rs2 = 2; trans.imm = 32'd260; trans.encode_instruction(); trans.display("GENERATOR-SH"); gen2driv.put(trans);
    ...
    trans.rd = 22;
    trans.imm = 32'd4;  // forward jump straight onto the halt loop
    trans.encode_instruction();
    trans.display("GENERATOR-JAL");
    gen2driv.put(trans);
  endtask
